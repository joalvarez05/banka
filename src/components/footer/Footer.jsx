      ...
      <footer className="py-4">
        <div className="accordion accordion-flush" id="accordionFlush">
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                ...
                que actualmente opera en más de 5 países de LATAM. N26 está
                ...
                Protección al Ahorro Bancario (IPAB). En funcionamiento desde el
                año 2022, a día de hoy cuenta con más de 1 millon de clientes.
              </div>
            </div>
          </div>
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                ...
                de nuestros clientes están garantizados hasta 10 000 USD por el
                Instituto para la Protección al Ahorro Bancario (IPAB). Además,
                la app de Banka cuenta con diferentes métodos de seguridad que
                garantizan la seguridad de las cuentas y los datos bancarios de
                los clientes.
              </div>
            </div>
          </div>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                Banka es una cuenta bancaria digital gratuita: no hay comisiones
                de mantenimiento de cuenta ni importes mínimos de depósito. Las
                cuentas premium aun estan en desarrollo.
              </div>
            </div>
          </div>
        </div>
